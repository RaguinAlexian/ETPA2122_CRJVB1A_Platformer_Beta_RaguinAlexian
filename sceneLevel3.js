class sceneLevel3 extends Phaser.Scene {
    ...
    init(data) {
        this.spawnXSortieSceneJoueur = 3036,
            this.spawnYSortieSceneJoueur = 544;
    }
    ...
    create() {
        ...
        this.portail = this.add.image(3820, 96, "portail");
    }

    update() {

        if (this.player.x >= 3772 && this.player.y >= 64 && this.player.y <= 160 || this.keyH.isDown) {
            this.musique.stop();
            this.tp.play();

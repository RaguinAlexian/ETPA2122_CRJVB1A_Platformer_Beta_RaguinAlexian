class sceneNico extends Phaser.Scene {
    constructor() {
        super("sceneNico");
    }

    init(data) {
        this.spawnXSortieSceneJoueur = 160,
    ...
    create() {
        ...
        this.portail = this.add.image(816, 800, "portail");
    }

    update() {

        if (this.player.x >= 768 && this.player.y >= 768 || this.keyH.isDown) {
            this.musique.stop();
            this.tp.play();

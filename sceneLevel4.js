class sceneLevel4 extends Phaser.Scene {
    ...
    init(data) {
        this.spawnXSortieSceneJoueur = 4380,
            this.spawnYSortieSceneJoueur = 224;
    }
    ...
    preload() {
        ...
        this.load.image("portailFin", "assets/portailFin.png")
    }
    ...
    create() {
        ...
        this.portailFin = this.add.image(5516, 224, "portailFin");
    }

    update() {

        if (this.keyH.isDown || this.player.x >= 5468 && this.player.y >= 192 && this.player.y <= 288) {
            this.musique.stop();
        ...
        if (this.dead == false) {
            ...
            if (goLeft == true) {
                if (this.chronoMinute < 3) {
                    ...
                    if (goUp == true && this.player.body.blocked.up) {
                    ...
                    if (specialButton && this.saut == 1 && !(this.player.body.blocked.up)) {
            ...
            else if (goUp == true && this.player.body.blocked.up) {
                if (this.chronoMinute < 3) {
                    this.jump.play()
                    this.player.setVelocityY(500);
                    this.saut = 1;
            ...
            else if (specialButton && this.saut == 1 && !(this.player.body.blocked.up)) {
